        ...
        <div className='flex flex-col text-center items-center justify-center my-10 py-16 md:flex-row md:space-x-4 md:text-left md:py-54 sm:py-34'>
            ...
            <div className='md:mt-2 md:w-3/5'>
                ...
                <p className='text-lg mt-4 mb-6 md:text-2xl'>
                    I'm a <span className='font-semibold text-red-500'>Full-Stack Software Developer {" "}</span>
                ...
                <Link
                    to='projects'
                    className='text-neutral-100 font-semibold px-6 py-3 bg-red-600 rounded shadow hover:bg-red-700 select-none'
                    activeClass='active'
                    spy={true}
                    smooth={true}
                    offset={-100}
