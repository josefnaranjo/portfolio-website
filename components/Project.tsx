...
const myProjects = [
    {
        name: "FireTube Video",
        description: "A full-stack web application developed using the MERN stack featuring JWT user verification and cookie authentication 💻",
        image: "/firetube.png",
    ...
    },
    {
        ...
        description: "A music player built with JavaScript and CSS, providing various useful features for enjoying your favorite music. 🎸",
    ...
    },
    {
        ...
        description: "This research project focused on social network analysis. I investigated the spread of misinformation within Facebook's social circles, utilizing Python and the NetworkX library. 📊",
    ...
    },
    {
        ...
        description: "A research project focused on data analytics and neural networks. I implemented an NLP neural network to assess customer satisfaction with a particular business. 📈",
        image: "/nlp.jpg",
    ...
    },
    {
        ...
        description: "This project was my first research project with the Computer Science department, where I applied artificial intelligence concepts. I utilized a Markov chain to predict demographic changes in an urban area. 📊",
                                    ...
                                    <div className='flex flex-row align-bottom space-x-4'>
                                        <Link href={item.platform} target='_blank'>
                                            {item.platform.includes('github') ? (
                                                <BsGithub className='hover:-translate-y-1 transition-transform cursor-pointer' size={30} />
                                            ) : (
                                                <AiFillGoogleSquare className='hover:-translate-y-1 transition-transform cursor-pointer' size={30} />
                                            )}
                                        </Link>
                                        {item.link && (
